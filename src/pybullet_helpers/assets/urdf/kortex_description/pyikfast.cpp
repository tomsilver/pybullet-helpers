...
static struct PyModuleDef pyikfastgen3_robotiq_2f_85module = {
    PyModuleDef_HEAD_INIT,
    "pyikfastgen3_robotiq_2f_85",
    "ikfast wrapper",
    -1,
    PyIkFastMethods};

PyMODINIT_FUNC PyInit_pyikfastgen3_robotiq_2f_85(void)
{
  PyObject *module = PyModule_Create(&pyikfastgen3_robotiq_2f_85module);
  return module;
}

...
def create_urdf_from_body_id(body_id: int, physics_client_id: int,
                             name: str = "pybullet-extracted") -> str:
    ...
    for link_idx in range(-1, num_joints):
        ...
        collision_data = p.getCollisionShapeData(body_id, link_idx, physicsClientId=physics_client_id)
